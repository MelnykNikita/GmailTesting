...
public class Mail {
    ...
    private static int ELEMENT_EXTRALONG_TIMEOUT_SECONDS = 120;
    ...
    @Step
    public static List<EmailMessage> getEmailMessages(String login,
                                                      String password, String folder, String expectedSubject, String expectedBody) {
        ...
        try {
            ...
            for (Message msg : messages) {
                ...
                if (content instanceof Multipart) {
                    ...
                    Object content1 = ((MimeMultipart) content)
                                    .getBodyPart(0)
                                    .getContent();
